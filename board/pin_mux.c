...
void BOARD_InitPins(void)
{
    ...
    PORT_SetPinMux(BOARD_INITPINS_CAN0_RX_PORT, BOARD_INITPINS_CAN0_RX_PIN, kPORT_MuxAlt11);
    ...
    PORT_SetPinMux(BOARD_INITPINS_CAN0_TX_PORT, BOARD_INITPINS_CAN0_TX_PIN, kPORT_MuxAlt11);
